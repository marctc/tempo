...
func (m *PushSpansRequest) GetBatches() []*v1.ResourceSpans {
	if m != nil {
		return m.Batches
	}
	return nil
...
func (m *Exception) GetExceptionId() string {
	if m != nil {
		return m.ExceptionId
	}
	return ""
}

func (m *Exception) GetSpans() []*v1.Span {
	if m != nil {
		return m.Spans
	}
	return nil
...
func (m *ExceptionResponse) GetExceptions() []*Exception {
	if m != nil {
		return m.Exceptions
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Exception)(nil), "tempopb.Exception")
	proto.RegisterType((*ExceptionResponse)(nil), "tempopb.ExceptionResponse")
}
...
var fileDescriptor_f22805646f4f62b6 = []byte{
	...
	,
}
...
func (m *Exception) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExceptionId) > 0 {
		i -= len(m.ExceptionId)
		copy(dAtA[i:], m.ExceptionId)
		i = encodeVarintTempo(dAtA, i, uint64(len(m.ExceptionId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Exception) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExceptionId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExceptionId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
